...
import com.gosylvester.higginsbarthow.util.SystemUiHider;
...
public class FullscreenActivity extends Activity implements OnClickListener {
	...
	private static final long TWENTY_SECONDS = 25000;
	...
	private void setup() {
		...
		pi = PendingIntent.getBroadcast(this, 0, new Intent(
				"com.gosylvester.higginsbarthow.mute"), 0);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b = (Button) findViewById(R.id.dummy_button2);
		b.setOnClickListener(this);
		b = (Button) findViewById(R.id.dummy_button3);
		b.setOnClickListener(this);
		setup();
	}
	...
	public void onResume() {
		...
		if (i != null) {
			if (i.getBooleanExtra("mute", false)) {
				this.mute();
				finish();
			}
		}
	...
	private void demute() {
		...
		// muter(false);
		Intent service = new Intent(this, MuteService.class);
		service.putExtra("mute", false);
	...
	private void mute() {
		...
		Intent service = new Intent(this, MuteService.class);
		service.putExtra("mute", true);
		startService(service);

	}

	private void muter(Boolean isMuted) {
